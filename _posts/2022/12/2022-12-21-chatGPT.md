...
**Google Brain** created Transformer in 2007. Eight years later, in 2015, OpenAI (a new company) chose the Transformer approach and began work on ChatGPI, which it released in 2022. People who believe it is some revolutionary invention that threatens Google should sit down because Google invented the **T** in ChatGPT.
